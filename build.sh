...
$HRB_EXE hwb -n -i$HRB_INC -i$HWGUI_INC -D__CONSOLE -es2
gcc hwb.c -ohwbc -I $HRB_INC -L $HRB_LIB -L $HWGUI_LIB -Wl,--start-group -lprocmisc $HARBOUR_LIBS -Wl,--end-group $SYSTEM_LIBS
