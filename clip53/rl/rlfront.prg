...
DO WHILE !exit_status
   ...
   SET CURSOR OFF
   @ 12,0 SAY "Line " + LTRIM(STR(RECNO())) + " อ"
...
pagehead  = "อออ Page Header อออ"
field_def = "อออ Column Definitions อออ"
group     = "อออ Group Specifications อออ"
sub_group = "อออ Sub-Group Specifications อออ"
