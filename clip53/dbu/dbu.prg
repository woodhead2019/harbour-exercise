...
*  DBU Main Module
*  CA-Clipper 5.3a.
*  Copyright (c) 1987 - 1996, Computer Associates International, Inc.
*  All rights reserved.
*  Compile with /m /n
*
***/
...
PROCEDURE Dbu( param1, param2, param3 )
   ...
   *** These parameters are optional and have the following meaning:
   *
   ...
   ***
   ...
   // Uncomment to turn on the mouse:
   // MSETCURSOR( .T. )
   ...
   view_err := "DBU - Copyright (c) 1987-1996, " + ;
